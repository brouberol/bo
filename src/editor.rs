...
impl Editor {
        ...
        match pressed_key {
            ...
            Key::Backspace => {
                ...
                if self.cursor_position.x == 0 {
                    ...
                    self.document.delete(self.current_x_position().saturating_sub(1), self.current_x_position(), self.current_row_index());
    ...
    fn delete_current_grapheme(&mut self) {
        self.document
            .delete(self.current_x_position(), self.current_x_position(), self.current_row_index());
    }
